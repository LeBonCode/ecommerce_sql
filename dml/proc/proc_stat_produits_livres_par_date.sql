DELIMITER |
DROP PROCEDURE IF EXISTS stat_produits_livres_par_date|

CREATE PROCEDURE stat_produits_livres_par_date(IN date_inf DATETIME, IN date_sup DATETIME)
BEGIN
...
CALL stat_produits_livres_par_date('2011-12-02', NOW())|
CALL stat_produits_livres_par_date('1995-12-02', '2012-01-01')|